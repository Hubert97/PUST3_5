...
table_Ystat(2,:)=char_stat_G2(1:10:1000,2);
table_Ystat(1,:)=linspace(1,100,100);
% table_Ustat(2,:)=linspace(1,100,100);

fname_Ystat = sprintf('YstatG22.txt');
% fname_Ustat = sprintf('UstatG22.txt');
mkdir_status=mkdir(sprintf('C:\\Users\\Kuba\\Desktop\\PUST lab 3.5\\charakterystyki statyczne\\'));
if mkdir_status
   savdir = sprintf('C:\\Users\\Kuba\\Desktop\\PUST lab 3.5\\charakterystyki statyczne\\');
